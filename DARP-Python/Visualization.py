...
class darp_area_visualization(object):
    def __init__(self, Assignment_matrix, DroneNo, color, init_robot_pos):
        ...
        self._VARS = {'surf': False,
                      ...
                      'lineWidth': 2}
        self.color = color
        self.color = [(253, 83, 67), (255, 159, 78), (131, 215, 127), (66, 205, 200)]
        self.init_robot_pos_colors = [np.clip((r[0] - 40, r[1] - 40, r[2] - 40), 0, 255).tolist() for r in self.color]
